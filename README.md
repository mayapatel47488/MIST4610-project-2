...
Understanding the relationship between English proficiency levels and their geographic location can further help inform educators or the public about potential disparities between English Language Learners crime and their geographic location. Since ELL students often come from culturally diverse backgrounds, ELL students often face unique challenges in educational settings, including language barriers and cultural differences. Understanding how their experiences vary by geographic location can inform policies and interventions to support their academic success. Geographic location serves as a crucial variable in this analysis, as it allows for comparisons between states with potentially different policies, demographics, and cultural contexts. By disaggregating the data by state, researchers can identify regional trends and disparities that may inform targeted interventions.
For instance, there were 3,142 English Language Learners out of the 51,780 student arrests in 2015-2016. There is a large range in percentage of English learners, as arrests per state varies from 0% English learners to 50%. What is the difference in ratios between states, and what is causing this wide variety? Texas has the highest number of arrests for English learners with 946, which makes up 12.3% of their school-related arrests. 
